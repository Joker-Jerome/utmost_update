...
netid = args[2]
input_expression_dir = "/gpfs/loomis/scratch60/zhao/zy92/GTEX/expr_gtex_mirna_updated/"
cov_dir = "/ysm-gpfs/pi/zhao-data/zy92/GTEx_V8/GTEx_Analysis_v8_eQTL_covariates/"
output_prefix = "/GTEX/adjusted_mirna_expr/" # /gpfs/loomis/scratch60/zhao/netid/prefix                    
