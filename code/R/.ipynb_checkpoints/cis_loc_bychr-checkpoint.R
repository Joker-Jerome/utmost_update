...
i <- chr
paste0("/ysm-gpfs/scratch60/wl382/GTEx/v8/genotype//GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.SHAPEIT2_phased_chr",i,".bim") -> bim_file
...
bim <- na.omit(bim)
gene_names <- list.files(paste0("/ysm-gpfs/project/wl382/GTEx_v8/genotype/cis_loc/chr",chr,"/"))
remain <- c()
...
write.table(remain,file=paste0("/ysm-gpfs/project/wl382/GTEx_v8/genotype/cis_loc/chr",chr,"_remainGenes.txt"),col.names=F,row.names=F,sep="\t",quote=F)
